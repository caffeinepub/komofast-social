import { c as createLucideIcon, r as reactExports, p as createDialogScope, j as jsxRuntimeExports, R as Root$2, T as Trigger, h as useComposedRefs, W as WarningProvider, b as createContextScope, q as Content, k as composeEventHandlers, s as createSlottable, t as Title, v as Description, w as Close, x as Portal, O as Overlay, e as cn, y as buttonVariants, n as useLayoutEffect2, z as React2, E as createSlot, F as useControllableState, d as Primitive, u as useApp, G as usePlatformStats, H as useApprovePost, J as useRejectPost, K as useToggleUserActive, m as motion, B as Button, C as Check, X, P as Plus, f as ue, D as Dialog, o as DialogContent, N as DialogHeader, Q as DialogTitle, I as Input, U as Textarea, V as RefreshCw } from "./index-BD3kMB2h.js";
import { B as Badge } from "./badge-CQJz1qXV.js";
import { u as useDirection, c as clamp } from "./index-BeKep1x5.js";
import { A as AVATAR_GRADIENTS, f as MOCK_PRODUCTS } from "./mockData-C0D4n2wq.js";
import { U as Users } from "./users-CFP9kEIz.js";
import { S as ShoppingBag } from "./shopping-bag-CxnPQbfg.js";
import { T as TrendingUp } from "./trending-up-Dls4ispW.js";
import { P as Package } from "./package-_PK3Btmw.js";
import { T as Trash2 } from "./trash-2-CVXT_DDI.js";
/**
...
function Admin() {
  ...
  const [pendingPosts, setPendingPosts] = reactExports.useState(MOCK_PENDING_POSTS);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-6xl mx-auto px-4 py-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-5", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:hidden flex gap-1 overflow-x-auto pb-1 w-full mb-4 scrollbar-hide", children: SIDEBAR_ITEMS.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        type: "button",
        onClick: () => setActiveSection(item.id),
        className: `flex-shrink-0 flex items-center gap-2 px-3 py-2 rounded-xl text-[12px] font-medium transition-all ${activeSection === item.id ? "komo-gradient text-white" : "bg-accent text-komo-text-secondary"}`,
        children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "flex-1 min-w-0", children: [
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "komo-surface rounded-2xl komo-card-shadow p-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-[13px] font-semibold text-foreground mb-2", children: "Ad Revenue" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[22px] font-bold komo-gradient-text", children: "$14,280" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-green-400 mt-1", children: "+12.4% this month" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "komo-surface rounded-2xl komo-card-shadow p-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-[13px] font-semibold text-foreground mb-2", children: "Boosted Posts" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[22px] font-bold komo-gradient-text", children: "284" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-green-400 mt-1", children: "Active boosts this week" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "komo-surface rounded-2xl komo-card-shadow p-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-[13px] font-semibold text-foreground mb-2", children: "Marketplace Commission" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[22px] font-bold komo-gradient-text", children: "$2,847" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-green-400 mt-1", children: "5% on all transactions" })
              ] })
            ] })
          ]
        }
      ...
      activeSection === "users" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "komo-surface rounded-2xl komo-card-shadow overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Table, { children: [
      ...
      activeSection === "moderation" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          initial: { opacity: 0 },
          animate: { opacity: 1 },
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { className: "bg-komo-badge/20 text-komo-blue border-komo-blue/30", children: [
                pendingPosts.length,
                " pending"
              ] })
            ] }),
            pendingPosts.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                "data-ocid": "admin.moderation.empty_state",
                className: "text-center py-16 komo-surface rounded-2xl komo-card-shadow",
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { size: 40, className: "text-green-400 mx-auto mb-3" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground font-semibold", children: "All clear!" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-komo-text-muted text-[13px] mt-1", children: "No posts pending review" })
                ]
              }
            ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-3", children: pendingPosts.map((post, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              motion.div,
              {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-1", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[13px] font-semibold text-foreground", children: post.username }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "text-[9px] bg-accent text-komo-text-muted border-0", children: post.type }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] text-komo-text-muted ml-auto", children: post.time })
                      ] }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[13px] text-komo-text-secondary", children: post.caption })
                    ] })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 mt-3", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      Button,
                      {
                        ...
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { size: 13, className: "mr-1" }),
                          " Approve"
                        ]
                      }
                    ),
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      Button,
                      {
                        ...
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(TriangleAlert, { size: 13, className: "mr-1" }),
                          " Flag"
                        ]
                      }
                    )
