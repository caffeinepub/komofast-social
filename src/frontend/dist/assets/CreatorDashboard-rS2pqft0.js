import { c as createLucideIcon, u as useApp, j as jsxRuntimeExports, m as motion, a1 as Video, a2 as Clapperboard, Z as Zap, B as Button, a as ue } from "./index-CpzuotMQ.js";
import { B as Badge } from "./badge-BqGmPXZx.js";
import { T as Trophy, P as Progress } from "./progress-B7SCRZ7z.js";
import { A as ArrowLeft } from "./arrow-left-KL8wJnD0.js";
import { U as Users } from "./users-BjyI-id0.js";
import { C as ChartNoAxesColumn } from "./chart-no-axes-column-CLVIJYbV.js";
import { G as Globe } from "./globe-5mMpFMRo.js";
import { S as Star } from "./star-Cg3kQGQI.js";
import { T as TrendingUp } from "./trending-up-DwBZj6rM.js";
/**
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-4", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Badge,
                    {
                      ...
                      children: "✅ Eligible for Monetization"
                    }
                  )
                ] }),
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-1.5", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(Users, { size: 14, className: "text-komo-blue" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[13px] font-medium text-foreground", children: "Real Followers" })
                      ] }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-1.5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                        Badge,
                        {
                          ...
                          children: "94% Authentic"
                        }
                      ) })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Progress, { value: 94, className: "h-2 bg-white/8" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-1.5", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(ChartNoAxesColumn, { size: 14, className: "text-komo-purple" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[13px] font-medium text-foreground", children: "Engagement Rate" })
                      ] }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[13px] font-bold text-foreground", children: "8.4%" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          Badge,
                          {
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Progress, { value: 84, className: "h-2 bg-white/8" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-komo-text-muted mt-1", children: "Above 3% threshold — excellent engagement" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-1.5", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { size: 14, className: "text-yellow-400" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[13px] font-medium text-foreground", children: "Content Originality" })
                      ] }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[13px] font-bold text-foreground", children: "100%" })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Progress, { value: 100, className: "h-2 bg-white/8" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-komo-text-muted mt-1", children: "All content verified as original" })
                  ] })
                ] })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { variants: item, className: "pt-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Button,
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-center text-[11px] text-komo-text-muted mt-2", children: "Review takes 3–5 business days · India eligible ✓" })
          ] })
        ]
      }
    )
