import { c as createLucideIcon, r as reactExports, l as createDialogScope, j as jsxRuntimeExports, R as Root$1, n as Trigger, o as useComposedRefs, W as WarningProvider, p as createContextScope, q as Content, s as composeEventHandlers, t as createSlottable, v as Title, w as Description, x as Close, y as Portal, O as Overlay, z as cn, E as buttonVariants, F as useControllableState, J as Primitive, K as usePrevious, N as useSize, u as useApp, Q as usePlatformStats, V as useApprovePost, Y as useRejectPost, _ as useToggleUserActive, m as motion, $ as Slider, a as ue, B as Button, P as Plus, D as Dialog, h as DialogContent, a0 as DialogHeader, a1 as DialogTitle, I as Input, T as Textarea, X, a2 as RefreshCw, C as Check, a3 as React } from "./index-C-s34q_b.js";
...
function DirectorManagementSection() {
  ...
  const handleAssign = () => {
    ...
    setAssignInput("");
    setAssignOpen(false);
    ue.success(`@${username} ko Director assign kiya gaya!`);
  };
  const handleRemove = (id, username) => {
    setDirectors((prev) => prev.filter((d) => d.id !== id));
    ue.error(`@${username} ko Director se remove kiya gaya.`);
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "komo-surface rounded-2xl komo-card-shadow overflow-hidden mb-5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 border-b border-komo-border flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-[14px] font-semibold text-foreground flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
              className: "w-5 h-5 rounded-md flex items-center justify-center",
              style: { background: "linear-gradient(135deg,#f59e0b,#d97706)" },
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(Shield, { size: 11, className: "text-white" })
            }
          ),
          "Director Management"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[12px] text-komo-text-muted mt-0.5", children: "Users ko Director role assign ya remove karen" })
      ] }),
    ...
    assignOpen && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "divide-y divide-komo-border/40", children: directors.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        "data-ocid": "owner.director.empty_state",
        className: "px-4 py-6 text-center text-[12px] text-komo-text-muted",
        children: "Koi Director assign nahi hai"
      }
    ) : directors.map((dir, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: dir.initials
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[13px] font-semibold text-foreground", children: dir.displayName }),
      ...
      activeSection === "owner" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(DirectorManagementSection, {}),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "komo-surface rounded-2xl komo-card-shadow overflow-hidden", children: [
