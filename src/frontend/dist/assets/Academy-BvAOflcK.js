import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, a2 as GraduationCap, g as Play, X, C as Check } from "./index-DqJhXVXX.js";
import { C as Crown } from "./crown-aPr5f31C.js";
import { S as Star } from "./star-bPX2pQAT.js";
...
function Academy() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl mx-auto px-4 py-4", children: [
    ...
    showSubscriptionModal && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 bg-black/80 z-50 flex items-end justify-center p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[#1A1F2B] rounded-3xl w-full max-w-md p-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3 mb-5", children: ["monthly", "yearly"].map((plan) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-gray-400 text-sm", children: plan === "monthly" ? "₹199 / month" : "₹999 / year (Save 58%!)" })
            ] }),
