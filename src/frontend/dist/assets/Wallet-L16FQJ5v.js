import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, C as Check, X } from "./index-zmx2XQHm.js";
import { W as Wallet, C as CreditCard, B as Building2 } from "./wallet-qidwwL0x.js";
import { T as TrendingUp } from "./trending-up-B8d_NEIz.js";
import { T as Tag } from "./tag-BdRxWEun.js";
/**
...
function WalletPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl mx-auto px-4 py-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-3 gap-3 mb-5", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-full bg-blue-500/20 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowUpRight, { size: 18, className: "text-blue-400" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-300 text-xs font-medium", children: "Add Money" })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: filteredTxns.map((txn, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
    ...
    showPromoModal && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 bg-black/80 z-50 flex items-end justify-center p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        "data-ocid": "wallet.promo.modal",
        className: "bg-[#1A1F2B] rounded-3xl w-full max-w-md p-6",
        children: promoApplied && (promoResult == null ? void 0 : promoResult.status) === "success" ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center py-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
          ...
          (promoResult == null ? void 0 : promoResult.status) === "error" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
